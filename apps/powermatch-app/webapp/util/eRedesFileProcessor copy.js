sap.ui.define([
	...
	var oBundle = that.oView.oParent.oModels.i18n.getResourceBundle();
		...
		// Create consumptions chart
		var ctx = document.getElementById("chartCanvas");

		// Mantém a instância do gráfico fora da função
		var oConsumptionChart;

		// Se já existir um gráfico neste canvas, destrói-o primeiro
		if (oConsumptionChart) {
    			oConsumptionChart.destroy();
		}

		// Cria novo gráfico
		oConsumptionChart = new Chart(ctx, {
    			type: "pie",
    			data: {
        				labels: [
